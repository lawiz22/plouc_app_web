    ...
    return (
      <View style={styles.container}>
            <Menu inverted style = {{ backgroundColor: COLOR.HOME }} attached='top'>
              ...
              {this.page.shotSongFront? <Icon link size='large' inverted color= 'red' circular name='music' style ={{  marginLeft: + 3 ,marginTop: + 6 ,width:45 , height : 45, borderWidth: 4, borderColor: COLOR.POST }}  onClick={() =>{ this.showSongfront()}} /> : <Icon size='large' link inverted bordered circular  name='music' style ={{  marginLeft: + 3 ,marginTop: + 6 ,width:45 , height : 45  }} onClick={() =>{ this.showSongfront()}} /> }
