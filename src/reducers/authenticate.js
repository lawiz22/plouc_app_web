...
export default function authenticate(state = initialState, action = {}) {
  switch (action.type) {
    ...
    case types.LOGIN_SUCCESSS: // When a Login success action has been dispatched
      return { // See more on actions/authenticate.js on line 19 - 38
        ...state,
        isAuth: true,
    ...
    case types.SET_PROFILE_VIEW_SUCCESS: // When a Login success action has been dispatched
      return { // See more on actions/authenticate.js on line 19 - 38
        ...state,
        showProfilefront: action.data.showProfile,
